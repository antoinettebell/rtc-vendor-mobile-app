...
assert.match(form, /employee_modified: true/);
assert.match(form, /filter\(\(item\) => item\.employee_modified_at\)/);
assert.match(form, /action: "UPDATED"/);
...
assert.match(inventory, /onPress: \(\) => setSelected\(null\)/);
...
assert.match(form, /Add Checklist Task/);
assert.match(form, /accessibilityLabel="Add additional task"/);
assert.match(form, /Task Title/);
assert.match(form, /Task Details/);
assert.match(form, /Active Tasks/);
assert.match(form, /taskListExpanded/);
assert.match(form, /archiveOperationalChecklistTask_API/);
assert.match(form, /createOperationalChecklistTask_API/);
assert.doesNotMatch(form, /startImmediately: true, addTask: true/);
