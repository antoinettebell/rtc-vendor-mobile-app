...
const missingPricePerGuest = getBidActionAvailability({
  eventId: "event-1",
  coordinatorBidSupported: true,
  notesError: "",
  guestCoverage: "REGULAR",
  fullyCateredEvent: false,
  fullBidAmount: "500.00",
  fullBidNumber: 500,
  regularGuestAmount: "",
  regularGuestAmountNumber: 0,
  vipCateringAmount: "",
...
assert.deepEqual(missingPricePerGuest, { canSaveDraft: true, canSubmit: false });
assert.match(
  getBidBlockingReasons({
    eventId: "event-1",
    coordinatorBidSupported: true,
